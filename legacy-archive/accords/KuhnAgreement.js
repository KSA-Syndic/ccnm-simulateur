...
import { validateAgreement } from '../agreements/AgreementInterface.js';
...
export const KuhnAgreement = {
    ...
    labels: {
        nomCourt: 'Kuhn',
        description: 'Accord d\'entreprise censé améliorer la convention : prime d\'ancienneté dès 2 ans (au lieu de 3), prime vacances, prime équipe, 13e mois et majorations (nuit, dimanche).'
    },
