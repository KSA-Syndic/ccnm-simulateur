...
const CONFIG = {
    ...
    // ╔════════════════════════════════════════════════════════════════╗
    // ║         CONVENTION COLLECTIVE NATIONALE (CCN) - MAJ 2026       ║
    // ╚════════════════════════════════════════════════════════════════╝
...
// Exposer la configuration runtime pour les modules ES qui doivent lire
// les surcharges effectuées dans ce fichier (ex. inclusDansSMH).
