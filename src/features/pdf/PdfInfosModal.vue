  ...
  <AppModal :open="open" title="Export PDF et lettre Word" @close="open = false">
    <div class="pdf-infos-body">
      <p class="pdf-infos-lead">
        Ces informations enrichissent l’annexe PDF et la lettre de mise en demeure (fichier Word
        .doc, ouvrable dans Word, LibreOffice ou un autre traitement de texte). Les champs vides
        conservent des mentions modèle dans la lettre.
      </p>
      ...
      <div
        ...
        class="letter-fields"
        aria-label="Champs optionnels pour la lettre Word"
      >
        <div class="form-group">
    ...
    <template #footer>
      ...
      <button class="book-btn btn-primary" @click="submit">Générer lettre Word + PDF</button>
    </template>
  </AppModal>
</template>
