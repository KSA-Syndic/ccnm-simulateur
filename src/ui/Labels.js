...
export const LABELS = {
    ...
    arreteesSmhSeulLabel: 'Calculer les arriérés sur le SMH seul (recommandé)',
    arreteesSmhSeulTooltipHtml: 'Mode SMH seul (Art. 140 CCNM) activé par défaut. Inclus : base, forfaits, 13e mois, heures supplémentaires et éléments inclus dans l\'assiette SMH. Décochez uniquement si vous voulez comparer à la rémunération complète (total brut bulletin).',
